    ...
    <Container fluid>
      ...
      <Row>
        <Col size="md-6">
          ...
          <button width="150" height="100" onClick={viewLinks} data-category="GitHub">
            {" "}
            GitHub <img src={github} width="50" height="50" alt="gitghub" data-category="GitHub" />{" "}
          </button>      
          <button width="150" height="100" onClick={viewLinks} data-category="HTML5">
            {" "}
            HTML5 <img src={html5} width="50" height="50" alt="html5" data-category="HTML5" />{" "}
          </button>
          <button width="150" height="100" onClick={viewLinks} data-category="CSS">
            {" "}
            CSS <img src={css} width="50" height="50" alt="css" data-category="CSS" />{" "}
          </button>
          <button width="150" height="100" onClick={viewLinks} data-category="Javascript">
            {" "}
            Javascript <img src={js} width="50" height="50" alt="js" data-category="Javascript" />{" "}
          </button>
          <button width="150" height="100" onClick={viewLinks} data-category="JQuery">
            {" "}
            JQuery <img src={jquery} width="50" height="50" alt="jquery" data-category="JQuery" />{" "}
          </button>   <br />        
          <button width="150" height="100" onClick={viewLinks} data-category="MongoDB">
            {" "}
            MongoDB <img
              src={mongo}
              width="50"
          ...
          <button width="150" height="100" onClick={viewLinks} data-category="Express">
            {" "}
            Express <img
              src={nExpress}
              width="50"
          ...
          <button width="150" height="100" onClick={viewLinks} data-category="ReactJS">
            {" "}
            React <img src={ract} width="50" height="50" alt="react" data-category="ReactJS"/>{" "}
          </button>{" "}
          <button width="150" height="100" onClick={viewLinks} data-category="Node.js">
            {" "}
            Node <img src={node} width="50" height="50" alt="node" data-category="Node.js" />{" "}
          </button>
          <button width="150" height="100" onClick={viewLinks} data-category="Heroku">
            {" "}
